package com.example.adapterdnb.security;
...
public class InternalAccessPolicyLoader {
    ...
    public List<InternalAccessPolicy.ClientRule> loadClientRules() throws IOException {
        ...
        PolicyDocument policyDocument = objectMapper.readValue(new File(policyProperties.getPath()), PolicyDocument.class);
        return policyDocument.getClients() == null ? Collections.emptyList() : policyDocument.getClients();
    }
